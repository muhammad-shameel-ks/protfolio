...
export default function ContactForm() {
  ...
  return (
    <section
      id="contact"
      className="px-6 md:px-12 lg:px-20 py-24 md:py-32 relative overflow-hidden bg-surface-warm/50"
    >
            ...
            {CONTACT_LINKS.map((item, i) => (
              ...
              >
                <div
                  ...
                  ${item.color === "green" ? "bg-pastel-green/50 text-green-600" : item.color === "blue" ? "bg-pastel-blue/50 text-blue-600" : item.color === "purple" ? "bg-pastel-purple/50 text-purple-600" : "bg-pastel-orange/50 text-orange-600"}
                `}
                >
                  {item.label === "Phone" && (
                    <svg
              ...
              >
                <div className="bg-pastel-orange/90 backdrop-blur-sm border-2 border-orange-200 p-3 rounded-2xl shadow-lg transform -rotate-2 max-w-[160px] sm:max-w-[200px] relative">
                  ...
                  <div className="absolute -bottom-10 right-4 text-orange-400 pointer-events-none">
                    ...
                    >
                      <path
                        d="M5 5C5 5 15 5 25 15C35 25 35 35 35 35"
                        stroke="currentColor"
                        strokeWidth="2.5"
                        strokeLinecap="round"
                        strokeDasharray="4 4"
              ...
              {status === "success" ? (
                ...
                >
                  ...
                  <p className="text-fg-muted">
                    I'll get back to you faster than a pod restart.
                  </p>
                  <button
